...
export const saunas: Sauna[] = [
  ...
  },
  {
    ...
    sessionLengthMinutes: 90,
    steamRoom: false,
    coldPlunge: true, // 4 temperature-controlled plunge pools
    soakingTub: false,
    waterfront: false,
    naturalPlunge: false,
    isOutside: true,
    showers: false,
    towelsIncluded: false, // Towel to sit on provided; bring your own to dry off
    capacity: 8,
  ...
  },
  {
    ...
    steamRoom: false,
    coldPlunge: true, // 3 individual non-chlorinated plunges (7-8°C winter, 12-13°C summer)
    soakingTub: false,
    waterfront: false,
    naturalPlunge: false,
    showers: true, // 1 communal shower
    towelsIncluded: true,
    capacity: 3,
  ...
  },
  {
    ...
    isOutside: true,
    showers: false,
    towelsIncluded: true, // Robes and towels provided
    capacity: 15,
  ...
  {
    slug: "secret-sauna-pdx",
    name: "Secret Sauna PDX",
    heaterType: "wood",
    address: "7033 NE Glisan Street, Portland, OR 97213",
    website: "https://www.secretsaunapdx.com/",
    bookingUrl: "https://www.secretsaunapdx.com/services-page",
    bookingPlatform: "wix",
    googleMapsUrl: "https://maps.app.goo.gl/S2aFjxPRFj65Kztq6",
    instagram: "secret.sauna.pdx",
    sessionPrice: 30,
    sessionLengthMinutes: 60,
    steamRoom: false,
    coldPlunge: false,
    ...
    capacity: 12,
    genderPolicy: "Co-ed",
    clothingPolicy: "Swimsuit required (nudity allowed in private sessions inside sauna only)",
    notes:
      "Portland's social sauna tucked behind Replicant bar in the Montavilla neighborhood. Wood-fired cedar sauna with a Narvi stove made in Finland. Four changing rooms, two outdoor showers (hot & cold), fire pit lounge area, and complimentary hydration station with water and herbal tea. Adjacent Mudd Works Cafe (until 3pm) and Replicant bar (after 12pm). Social sessions are shared with other guests. Private 90-min sessions available for up to 12 people ($270). 18+ only. Towels and slides available for rental.",
    lat: 45.526573807225496,
    lng: -122.59064700339987,
    updatedAt: "2026-03-06",
    images: [
      {
        url: "/saunas/secret-sauna-pdx/enter-here.png",
        alt: "Secret Sauna PDX located behind Replicant bar in Portland's Montavilla neighborhood",
      },
    ],
    bookingProvider: {
      type: "wix",
      siteUrl: "www.secretsaunapdx.com",
      timezone: "America/Los_Angeles",
      services: [
        {
          serviceId: "773372bd-55ab-4291-b354-e49298bff0df",
          name: "60-min social sauna session",
          price: 30,
          durationMinutes: 60,
        },
        {
          serviceId: "9fcbe440-f4e4-48f2-84cb-28cd873f1c34",
          name: "90-min social sauna session",
          price: 40,
          durationMinutes: 90,
        },
      ],
