...
export const saunas: Sauna[] = [
  ...
  },
  {
    ...
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/asheville-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
  ...
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/charlotte-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
  ...
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/durham-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
  ...
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/raleigh-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
    ...
    clothingPolicy: "Swimsuit required",
    notes:
      "Nordic bathhouse in Raleigh offering the signature Hot-Cold-Relax bathing circuit. 2-hour access includes traditional saunas, cold plunges, and heated lounge furniture. Private rooms and infrared suites available. Café and massage therapy on-site. Drop-in $50, memberships available.",
    lat: 35.7762469,
    lng: -78.648247,
    updatedAt: "2026-02-28",
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/greenville-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
  ...
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/knoxville-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
    ...
    clothingPolicy: "Swimsuit required",
    notes:
      "Nordic bathhouse in North Knoxville's revitalizing Emory Place district. 2-hour bathing circuit with traditional saunas, cold plunges, and heated lounge furniture. Private rooms and infrared suites available. Café and massage therapy on-site. Drop-in $50, memberships available.",
    lat: 35.9757102,
    lng: -83.9248187,
    updatedAt: "2026-02-28",
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/bonita-springs-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
  ...
  },
  {
    ...
    bookingUrl: "https://book.saunahouse.com/",
    bookingPlatform: "boulevard",
    googleMapsUrl: "https://maps.app.goo.gl/austin-sauna-house",
    sessionPrice: 50,
    sessionLengthMinutes: 120,
    steamRoom: false,
    coldPlunge: true,
    ...
    clothingPolicy: "Swimsuit required",
    notes:
      "Nordic bathhouse on Austin's North Loop. 2-hour bathing circuit with traditional saunas, cold plunges, and heated lounge furniture. Private rooms and infrared suites available. Café and massage therapy on-site. Drop-in $50, memberships available.",
    lat: 30.3247522,
    lng: -97.7380251,
    updatedAt: "2026-02-28",
  },
